...
(if (fboundp 'register-definition-prefixes) (register-definition-prefixes "ledger-commodities" '("ledger-" "+commodity" "-commodity")))
...
(if (fboundp 'register-definition-prefixes) (register-definition-prefixes "ledger-fonts" '("ledger-font-lock-keywords")))
...
(if (fboundp 'register-definition-prefixes) (register-definition-prefixes "ledger-schedule" '("ledger-schedule-" "between")))
